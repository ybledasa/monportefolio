  ...
  return (
    ...
    >
      <div style={{
        ...
        alignItems: 'center', // La photo reste centrée
      }}>
        {/* PHOTO RONDE */}
        <img
...
// Fonction pour afficher une compétence
function renderSkill(icon, title, stars) {
  return (
    ...
    >
      <img src={icon} alt={title} style={{ width: '40px', marginBottom: '10px' }} />
      <p style={{ fontSize: '16px', margin: '5px 0' }}>{title}</p>
